...
export default StyleSheet.create({
    ...
    brand: { fontSize: 32, fontWeight: 'bold', color: '#966D46', marginBottom: 5, fontFamily: 'Raleway-Regular' },
    slogan: { fontSize: 16, fontStyle: 'italic', color: '#af845cff', marginBottom: 20 },
    inputContainer: { flexDirection: 'row', alignItems: 'center', width: '100%', backgroundColor: '#fff', borderWidth: 1, borderColor: '#966D46', borderRadius: 10, paddingHorizontal: 10, marginBottom: 10 },
    input: { flex: 1, padding: 10, color: '#666' },
    icon: { marginRight: 10 },
    button: { backgroundColor: '#966D46', padding: 10, borderRadius: 10, marginTop: 10, width: '100%', alignItems: 'center' },
    ...
    linkText: { color: '#af845cff', marginTop: 10, fontSize: 14 },
  });
